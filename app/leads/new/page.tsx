    ...
    <div className="p-6 lg:p-8 max-w-2xl">
      ...
      <form onSubmit={submit} className="card p-6 space-y-4">
        <div className="grid gap-4 md:grid-cols-2">
          <div>
            <label className="label">Name <span className="text-[#38BDF8]">*</span></label>
        ...
        <button type="submit" disabled={loading}
          className="flex w-full items-center justify-center gap-2 rounded-lg bg-[#38BDF8] py-3 text-[13px] font-medium text-white transition-all hover:opacity-90 disabled:opacity-50">
